        ...
        <div className="lg:w-[65.667%]">
          <div className="mb-[40px]">
            <div className="relative">
              <p className="font-poppins font-bold text-[clamp(2rem,5vw,68.8px)] leading-[1.2] text-white text-left">
                {phoneLabel}
              </p>
            </div>
          </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="font-poppins text-[18px] leading-[18px] text-black pb-[10px] font-normal group-hover:text-white transition-colors duration-300">
                  {phoneLabel}
                </p>
                <p className="font-poppins text-[clamp(1.5rem,4vw,40px)] text-black leading-tight group-hover:text-white transition-colors duration-300">
                  {phoneDisplay}
                </p>
              </div>
            </div>
