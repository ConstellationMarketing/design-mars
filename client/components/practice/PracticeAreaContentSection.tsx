      ...
      <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%] lg:w-[85%]">
        ...
        >
          ...
          <div className={showCTAs || section.image ? "lg:w-[60%]" : "w-full"}>
            <RichText
              html={section.body}
              className="font-poppins text-[16px] md:text-[18px] leading-[26px] md:leading-[30px] text-black/90 prose prose-lg max-w-none
                [&_h2]:font-poppins [&_h2]:font-bold [&_h2]:text-[28px] [&_h2]:md:text-[36px] [&_h2]:leading-tight [&_h2]:text-black [&_h2]:mb-4
                [&_h3]:font-poppins [&_h3]:font-bold [&_h3]:text-[22px] [&_h3]:md:text-[28px] [&_h3]:leading-tight [&_h3]:text-black [&_h3]:mb-3
