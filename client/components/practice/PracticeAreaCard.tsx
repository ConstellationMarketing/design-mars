...
export default function PracticeAreaCard({
  ...
  return (
    <div className="practice-flip-card relative min-h-[450px] overflow-hidden group bg-brand-card border border-brand-border">
      {/* Front side - Image and content */}
      <div className="practice-flip-card-front absolute inset-0 w-full h-full">
        {/* Background Image */}
        <div
          role="img"
      ...
      <Link
        to={link}
        className="practice-flip-card-back absolute inset-0 w-full h-full bg-brand-accent p-[25px] md:p-[30px] flex flex-col items-center justify-center text-center"
      >
