      ...
      <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%]">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-[5%]">
          ...
          <div className="lg:w-[65%]">
            <h1 className="font-poppins text-[18px] md:text-[24px] leading-tight md:leading-[36px] text-brand-accent mb-[10px]">
              {content.sectionLabel}
            </h1>

            <p className="font-poppins font-bold text-[clamp(2.5rem,7vw,68.8px)] leading-[1.2] text-white mb-[20px] md:mb-[30px]">
              {content.tagline}
            </p>

            <RichText
              html={content.description}
              className="font-poppins text-[16px] md:text-[20px] leading-[24px] md:leading-[30px] text-white/90"
            />
          </div>
