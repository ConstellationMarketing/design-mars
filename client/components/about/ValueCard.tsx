  ...
  return (
    <div className="group">
      <div className="flex flex-col items-center text-center">
        ...
        {/* Content Section */}
        <div>
          <h3 className="font-poppins font-bold text-[24px] md:text-[32px] leading-tight text-white pb-[10px] md:pb-[15px]">
            {title}
          </h3>
          <RichText
            html={description}
            className="font-poppins text-[14px] md:text-[16px] leading-[22px] md:leading-[26px] text-white/80"
          />
        </div>
      </div>
    </div>
