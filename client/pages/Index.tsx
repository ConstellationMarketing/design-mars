          ...
          <div className="flex flex-col items-center justify-center gap-5 md:gap-6">
            ...
            <div className="border-2 border-brand-accent p-1 hover:border-black transition-all duration-300 hover:bg-white" style={{ marginTop: '30px', marginBottom: '70px', width: '393px' }}>
              ...
              <button
                ...
                className="font-poppins text-[18px] font-medium uppercase text-black bg-brand-accent px-10 py-5 border-2 border-black hover:bg-white hover:text-black hover:border-white transition-all duration-300 flex items-center justify-center gap-3"
                style={{ width: '100%' }}
              >
